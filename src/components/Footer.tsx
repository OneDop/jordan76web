          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '0.8rem' }}>
              {[{ icon: <Share2 size={18} /> }, { icon: <MessageSquare size={18} /> }, { icon: <Code size={18} /> }, { icon: <Globe size={18} /> }].map((s, idx) => (
                <a key={idx} href="#" style={{ width: '44px', height: '44px', borderRadius: '6px', background: 'rgba(0, 27, 58, 0.8)', border: '1px solid rgba(126, 243, 232, 0.3)', color: '#7EF3E8', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>{s.icon}</a>
              ))}
            </div>
          </div>
          <div>
